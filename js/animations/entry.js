...
class EntrySection extends SectionAnimationBase {
  ...
  buildScenario() {
    ...
    return [
      ...
      addLabel('start'),
      { type: 'from', target: words[0], props: { [motionDir]: -25, [otherDir]: wordResetPos, opacity: 0, ...EASING } },
      { type: 'from', target: words[1], props: { [motionDir]: -25, [otherDir]: wordResetPos, opacity: 0, ...EASING } },
      { type: 'from', target: words[2], props: { [motionDir]: -25, [otherDir]: wordResetPos, opacity: 0, ...EASING } },
      { type: 'from', target: words[3], props: { [motionDir]: -25, [otherDir]: wordResetPos, opacity: 0, ...EASING } },
